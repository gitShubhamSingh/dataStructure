...
int main()
{
	cout << "\nPriority Queue with Normal Insertion and Priority deletion with Stack in Ascending.\n\nAscending = Lowest Value will delete first";
	int sizeOfQueue, choice;
	cout << "\nPlease Enter the Size ofthe Queue: ";
	cin >> sizeOfQueue;
	Queue *queue;
	queue = createQueue(sizeOfQueue);
	while (1)
	{
		cout << "\n\nOption:-\n\n1. Enqueue\n2. Dequeue\n0. Exit\n\nchoice: ";
		cin >> choice;
